...
Unless the user specifies a different style, design with the visual quality and product discipline typically seen in modern financial software, analytics platforms, and high-trust B2B SaaS products. Favor interfaces that feel:
...
If no images are provided, prefer product-style visuals, interface compositions, data-driven sections, or restrained visual treatments over generic stock imagery.

For modern, professional, operational, or business interfaces, default to light mode unless the user says otherwise.
